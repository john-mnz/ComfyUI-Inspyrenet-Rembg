...
class Remover:
    def __init__(self, mode="base", jit=False, device=None, ckpt=None, fast=None , ckpt_path:str = None):
        """
        Args:
        ...
        if ckpt_path is None:
            import folder_paths # Custom Model Path +20240912
            home_dir = os.path.expanduser(os.path.join(folder_paths.models_dir , "transparent-background"))
        else:
            home_dir = ckpt_path
